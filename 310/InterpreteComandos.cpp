...
void InterpreteComandos::juanagra(string palabra){
    string juanagrama = diccionario.getJuanagrama(palabra);
    if(juanagrama!=""){
        cout << "Juanagrama: " << Diccionario::normalizarPalabra(palabra) << " -> " << juanagrama << endl;
    }
    else{
...
void InterpreteComandos::alarga(string prefijo){
    string prefijoNormalizado = Diccionario::normalizarPalabra(prefijo);
    string palabraMasLarga = diccionario.getPalabraMasLarga(prefijoNormalizado);
    if (!palabraMasLarga.empty()) {
        cout << "Alarga: " << prefijoNormalizado << " -> " << palabraMasLarga << endl;
    } else {
        cout << "Alarga: " << prefijoNormalizado << " ->" << endl;
    }
}
